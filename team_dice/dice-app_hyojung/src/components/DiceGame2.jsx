...
const DiceGame2 = () => {
    ...
    const [userScore, setUserScore] = userState(0);
    const [userDiceImg, setUserDiceImg] = useState(`${imgPath}1.png`);

    const [comScore, setComScore] = userState(0);
    ...
    const throwDice = () => {
        ...
        // 주사위 눈 이미지 초기화
        userDiceImg(`${imgPath}${userIndex}.png`);
        comDiceImg(`${imgPath}${comIndex}.png`);
    ...
    return (
        <div>
            ...
            <BoardArea2 userScore={userScore} comScore={comScore} userDiceImg={userDiceImg} comDiceImg={comDiceImg}/>
        </div>
    )
}
